...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 gffread \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 hisat2-build \
...
do
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py align \
...
for sample in A1 A2 B1 B2
do
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py reconstruct \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 salmon index \
				-t /work_dir/example/Homo_sapiens.GRCh38.cdna.21.fa  \
				-i /work_dir/example/Homo_sapiens.GRCh38.cdna.21.Salmon.fmd \
				--type fmd
for sample in A1 A2 B1 B2
do
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py quantify \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py diff \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py denovo \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py fusion \
...
docker run -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py long_correct \
				--kmer 23 \
				--solid 3 \
				...
				--workdir /work_dir/example/work \
				--sample C
docker run  -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 chmod -R 777 /work_dir/example/work/lordec
docker run  -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 chmod -R 777 /work_dir/example/out/lordec
...
docker run -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 STAR \
				...
				--runThreadN 4
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py long_align \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py align \
				...
				--sample C
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py long_reconstruct \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py align \
				...
				--sample F \
				--hisat2_opts \"-f\"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py long_fusion \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 bgzip /work_dir/example/All_20180418.vcf
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 tabix /work_dir/example/All_20180418.vcf.gz
echo "Index reference genome FASTA file"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 samtools faidx /work_dir/example/GRCh38_full_analysis_set_plus_decoy_hla.fa
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 java -jar /usr/local/bin/picard.jar CreateSequenceDictionary \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py align \
				...
				--sample E \
				--threads 10
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py variant \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py editing \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 bgzip /work_dir/example/variants_21.vcf
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 tabix /work_dir/example/variants_21.vcf.gz
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 samtools faidx /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 java -jar /usr/local/bin/picard.jar CreateSequenceDictionary \
				R= /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa \
				O= /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.dict
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 run_rnacocktail.py all \
				--outdir /work_dir/example/out \
				--workdir /work_dir/example/work \
				--threads 10 \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 gmap_build \
				-d /work_dir/example/gmap_chromosome.21 \
				/work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.0 bowtie2-build \
				/work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa \
