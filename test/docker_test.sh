...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 gffread /work_dir/example/Homo_sapiens.GRCh38.90.chromosome.21.gtf -g /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa -w /work_dir/example/Homo_sapiens.GRCh38.cdna.21.fa
...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 hisat2-build /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.HISAT2
...
for sample in A1 A2 B1 B2
do
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 run_rnacocktail.py reconstruct --alignment_bam /work_dir/example/work/hisat2/${sample}/alignments.sorted.bam --outdir /work_dir/example/out --workdir /work_dir/example/work --ref_gtf /work_dir/example/Homo_sapiens.GRCh38.90.chromosome.21.gtf --sample ${sample}
done
...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 salmon index -t /work_dir/example/Homo_sapiens.GRCh38.cdna.21.fa  -i /work_dir/example/Homo_sapiens.GRCh38.cdna.21.Salmon.fmd --type fmd
for sample in A1 A2 B1 B2
do
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 run_rnacocktail.py quantify --quantifier_idx /work_dir/example/Homo_sapiens.GRCh38.cdna.21.Salmon.fmd --1 /work_dir/${sample}_1.fq.gz --2 /work_dir/${sample}_2.fq.gz --libtype IU --salmon_k 19 --outdir /work_dir/example/out --workdir /work_dir/example/work --threads 10 --sample ${sample} --unzip
done
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 run_rnacocktail.py denovo --1 /work_dir/A1_1.fq.gz --2 /work_dir/A1_2.fq.gz --outdir /work_dir/example/out --workdir /work_dir/example/work --threads 4 --sample A1 --file_format fastq.gz
...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 run_rnacocktail.py fusion --data_dir /work_dir/example/fusioncatcher_data/human_v90/ --input /work_dir/example/fusioncatcher_data/reads_1.fq.gz,/work_dir/example/fusioncatcher_data/reads_2.fq.gz --outdir /work_dir/example/out --workdir /work_dir/example/work --threads 4 --sample D
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 run_rnacocktail.py long_correct --kmer 23 --solid 3 --short /work_dir/example/C_short.fa --long /work_dir/example/C_long.fa --outdir /work_dir/example/out --workdir /work_dir/example/work --sample C
...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 STAR --runMode genomeGenerate --genomeDir /work_dir/example/STAR_genome_index_21/ --genomeFastaFiles /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa --runThreadN 4
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2.2 run_rnacocktail.py long_align --long /work_dir/example/work/lordec/C/long_corrected.fa --threads 4 --outdir /work_dir/example/out --workdir /work_dir/example/work --sample C --genome_dir /work_dir/example/STAR_genome_index_21/
