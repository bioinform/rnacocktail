...
# docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 hisat2-build /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.fa /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.HISAT2
# for sample in A1 A2 B1 B2
# do
# docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 run_rnacocktail.py align --align_idx /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.HISAT2 --outdir /work_dir/example/out --workdir /work_dir/example/work --ref_gtf /work_dir/example/Homo_sapiens.GRCh37.75.chromosome.21.gtf --1 /work_dir/${sample}_1.fq.gz  --2 /work_dir/${sample}_2.fq.gz --sample ${sample}
# done
# echo "--------------------------------------------------------"
# echo "--------------------------------------------------------"
...
# for sample in A1 A2 B1 B2
# do
# docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 run_rnacocktail.py reconstruct --alignment_bam /work_dir/example/work/hisat2/${sample}/alignments.sorted.bam --outdir /work_dir/example/out --workdir /work_dir/example/work --ref_gtf /work_dir/example/Homo_sapiens.GRCh37.75.chromosome.21.gtf --sample ${sample}
# done
# 
# echo "--------------------------------------------------------"
# echo "--------------------------------------------------------"
...
# docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 salmon index -t /work_dir/example/Homo_sapiens.GRCh37.75.cdna.21.fa  -i /work_dir/example/Homo_sapiens.GRCh37.75.cdna.21.Salmon.fmd --type fmd
# for sample in A1 A2 B1 B2
# do
# docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 run_rnacocktail.py quantify --quantifier_idx /work_dir/example/Homo_sapiens.GRCh37.75.cdna.21.Salmon.fmd --1 /work_dir/${sample}_1.fq.gz --2 /work_dir/${sample}_2.fq.gz --libtype IU --salmon_k 19 --outdir /work_dir/example/out --workdir /work_dir/example/work --threads 10 --sample ${sample} --unzip
# done
# 
# echo "--------------------------------------------------------"
# echo "--------------------------------------------------------"
...
# echo "--------------------------------------------------------"
# echo "--------------------------------------------------------"
# docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 run_rnacocktail.py denovo --1 /work_dir/A1_1.fq.gz --2 /work_dir/A1_2.fq.gz --outdir /work_dir/example/out --workdir /work_dir/example/work --threads 4 --sample A1 --file_format fastq.gz
# 
# 
# echo "--------------------------------------------------------"
# echo "--------------------------------------------------------"
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 run_rnacocktail.py long_correct --kmer 23 --solid 3 --short /work_dir/example/C_short.fa --long /work_dir/example/C_long.fa --outdir /work_dir/example/out --workdir /work_dir/example/work --sample C
...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 samtools faidx /work_dir/example/human_g1k_v37.fasta
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 java -jar /usr/local/bin/picard.jar CreateSequenceDictionary R= /work_dir/example/human_g1k_v37.fasta O= /work_dir/example/human_g1k_v37.dict
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 hisat2-build /work_dir/example/human_g1k_v37.fasta /work_dir/example/human_g1k_v37.HISAT2
...
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 samtools faidx /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.fa
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 java -jar /usr/local/bin/picard.jar CreateSequenceDictionary R= /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.fa O= /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.dict
docker run -v=${PWD}/../:/work_dir/  rnacocktail:0.2 run_rnacocktail.py all --outdir /work_dir/example/out --workdir /work_dir/example/work --threads 10 --1 /work_dir/A1_1.fq.gz,/work_dir/A2_1.fq.gz /work_dir/B1_1.fq.gz,/work_dir/B2_1.fq.gz --2 /work_dir/A1_2.fq.gz,/work_dir/A2_2.fq.gz /work_dir/B1_2.fq.gz,/work_dir/B2_2.fq.gz --sample all_A1,all_A2 all_B1,all_B2  --ref_gtf /work_dir/example/Homo_sapiens.GRCh37.75.chromosome.21.gtf  --ref_genome /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.fa --align_idx /work_dir/example/Homo_sapiens.GRCh37.75.dna.chromosome.21.HISAT2  --quantifier_idx /work_dir/example/Homo_sapiens.GRCh37.75.cdna.21.Salmon.fmd --unzip --file_format fastq.gz --IndelRealignment --CleanSam --knownsites /work_dir/example/variants_21.vcf --strand_pos /work_dir/example/GRCh37_strand_pos.bed --genes_pos /work_dir/example/GRCh37_genes_pos.bed --data_dir /work_dir/example/fusioncatcher_data/ensembl_v86/ --giremi_dir /usr/local/bin/ --gatk /work_dir/GenomeAnalysisTK.jar --htslib_dir /opt/htslib-1.3/ --picard /usr/local/bin/picard.jar
