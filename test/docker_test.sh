...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 gffread \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 hisat2-build \
...
do
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py align \
...
for sample in A1 A2 B1 B2
do
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py reconstruct \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 salmon index \
				-t /work_dir/example/Homo_sapiens.GRCh38.cdna.21.fa  \
				-i /work_dir/example/Homo_sapiens.GRCh38.cdna.21.Salmon.fmd \
				--type fmd
for sample in A1 A2 B1 B2
do
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py quantify \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py diff \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py denovo \
...
wget https://sourceforge.net/projects/fusioncatcher/files/data/human_v98.tar.gz.aa
wget https://sourceforge.net/projects/fusioncatcher/files/data/human_v98.tar.gz.ab
wget https://sourceforge.net/projects/fusioncatcher/files/data/human_v98.tar.gz.ac
wget https://sourceforge.net/projects/fusioncatcher/files/data/human_v98.tar.gz.ad 
cat human_v98.tar.gz.* | tar xz
rm -rf human_v98.tar.gz.a*
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py fusion \
...
docker run -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py long_correct \
				--kmer 23 \
				--solid 3 \
				...
				--workdir /work_dir/example/work \
				--sample C
docker run  -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 chmod -R 777 /work_dir/example/work/lordec
docker run  -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 chmod -R 777 /work_dir/example/out/lordec
docker run  -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 chmod -R 777 /work_dir/example/C_short.fa_k23_s3.h5
...
docker run -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 STAR \
				...
				--runThreadN 4
docker run  -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 chmod -R 777 /work_dir/example/STAR_genome_index_21
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py long_align \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py align \
				...
				--sample C
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py long_reconstruct \
...
# 				--sample F \
# 				--hisat2_opts \"-f\"
# docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py long_fusion \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 bgzip /work_dir/example/All_20180418.vcf
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 tabix /work_dir/example/All_20180418.vcf.gz
echo "Index reference genome FASTA file"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 samtools faidx /work_dir/example/GRCh38_full_analysis_set_plus_decoy_hla.fa
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 java -jar /usr/local/bin/picard.jar CreateSequenceDictionary \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py align \
				...
				--sample E \
				--threads 10
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py variant \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py editing \
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 bgzip /work_dir/example/variants_21.vcf
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 tabix /work_dir/example/variants_21.vcf.gz
...
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 samtools faidx /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 java -jar /usr/local/bin/picard.jar CreateSequenceDictionary \
				R= /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa \
				O= /work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.dict
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 run_rnacocktail.py all \
				--outdir /work_dir/example/out \
				--workdir /work_dir/example/work \
				--threads 10 \
...
echo "--------------------------------------------------------"
echo "--------------------------------------------------------"
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 gmap_build \
				-d /work_dir/example/gmap_chromosome.21 \
				/work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa
docker run -u $UID -v=${PWD}/../:/work_dir/ rssbred/rnacocktail:0.3.2 bowtie2-build \
				/work_dir/example/Homo_sapiens.GRCh38.dna.chromosome.21.fa \
